...
import { IconWashMachine, IconShirtFilled, IconCheck, IconX } from '@tabler/icons-react';
...
const MachineList = () => {
  ...
  const floorOptions = [
    { label: 'すべて', value: 'all' },
    ...Array.from({ length: 3 }, (_, i) => ({ label: `${i + 1}F`, value: String(i + 1) }))
  ];
      ...
      <Paper p="md" radius="md" withBorder>
        <Group position="apart" align="center">
          ...
          <SegmentedControl
            ...
            onChange={(value) => setSelectedFloor(value === 'all' ? null : value)}
            data={floorOptions}
            size="sm"
          />
        </Group>
              ...
              <Card shadow="sm" p="lg" radius="md" withBorder>
                <Group position="apart">
                  <Group>
                    <ThemeIcon 
                      size="xl" 
                      radius="md"
                      color={machine.active ? (machine.available ? "teal" : "red") : "gray"}
                      variant="light"
                    >
                    ...
                    <div>
                      ...
                      <Text size="sm" color="dimmed">階数: {machine.floor}F</Text>
                    </div>
                  </Group>
                ...
                <Group position="apart" mt="xs">
                  ...
                  <Badge 
                    ...
                    rightSection={machine.available ? 
                      <IconCheck size={14} /> : 
                      <IconX size={14} />
                    }
                  >
